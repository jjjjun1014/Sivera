...
export default function GoogleAdsSearchPage() {
  ...
  return (
    <div className="container mx-auto px-6 py-8">
      <div className="mb-6">
        <h1 className="text-3xl font-bold mb-2">Google Ads - Display</h1>
        <p className="text-default-500">디스플레이 광고 성과를 관리하세요</p>
      </div>
      ...
      <AIChatAssistant
        context={{
          currentPage: "/dashboard/platforms/google-ads/display",
          campaigns: campaigns,
          selectedMetrics: chartMetrics,
        }}
      />

      <ContextHelpCard page="/dashboard/platforms/google-ads/display" />
    </div>
  );
}
