...
export default function GoogleAdsSearchPage() {
  ...
  return (
    <div className="container mx-auto px-6 py-8">
      <div className="mb-6">
        <h1 className="text-3xl font-bold mb-2">Google Ads - Shopping</h1>
        <p className="text-default-500">쇼핑 광고 성과를 관리하세요</p>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          >
            ...
            <Tab key="ads" title="Product Group" />
          </Tabs>
        </CardHeader>
        <CardBody>
          ...
          {selectedTab === "ads" && (
            <>
              <div className="flex justify-between items-center mb-4">
                <div className="flex items-center gap-3">
                  <h3 className="text-xl font-semibold">제품 그룹 목록 ({filteredAds.length})</h3>
                  {selectedAdGroupName && (
                    <Button
                      size="sm"
                      variant="flat"
      ...
      <AIChatAssistant
        context={{
          currentPage: "/dashboard/platforms/google-ads/shopping",
          campaigns: campaigns,
          selectedMetrics: chartMetrics,
        }}
      />

      <ContextHelpCard page="/dashboard/platforms/google-ads/shopping" />
    </div>
  );
}
