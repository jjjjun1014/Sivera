  ...
  return (
    <div className="container mx-auto px-6 py-8">
      <div className="mb-6">
        ...
        <p className="text-default-500">스폰서 디스플레이 광고 성과를 관리하세요</p>
      </div>
      ...
      <ContextHelpCard page="/dashboard/platforms/amazon-ads/sponsored-display" />
    </div>
  );
}
